...
/// The property scope used by an AudioDriverKit control or custom property.
public struct AudioObjectScope: RawRepresentable, Sendable, Hashable {
  /// The unmodified AudioDriverKit value.
  public let rawValue: UInt32
  /// Creates a value from the supplied AudioDriverKit fields.
...
/// The class identifier reported for an AudioDriverKit control.
public struct AudioControlClass: RawRepresentable, Sendable, Hashable {
  /// The unmodified AudioDriverKit value.
  public let rawValue: UInt32
  /// Creates a value from the supplied AudioDriverKit fields.
  public init(rawValue: UInt32) { self.rawValue = rawValue }
...
/// Metadata shared by AudioDriverKit controls.
public struct AudioControlMetadata: Sendable, Hashable {
  ...
  /// The AudioDriverKit property element.
  public let element: UInt32
  /// The AudioDriverKit property scope.
  public let scope: AudioObjectScope
  /// The class identifier reported to the host.
  public let controlClass: AudioControlClass
  ...
  public init(
    ...
    controlClass: AudioControlClass
  ) {
...
/// Configuration for a boolean AudioDriverKit control.
public struct AudioBooleanControlConfiguration: Sendable, Hashable {
  /// Metadata shared by the control.
  public let metadata: AudioControlMetadata
  /// The value selected when the device is created.
  public let initialValue: Bool
  /// Creates a value from the supplied AudioDriverKit fields.
  public init(metadata: AudioControlMetadata, initialValue: Bool) {
...
public struct AudioLevelControlConfiguration: Sendable, Hashable {
  /// Metadata shared by the control.
  public let metadata: AudioControlMetadata
...
public struct AudioSelectorValue: Sendable, Hashable {
...
public struct AudioSelectorControlConfiguration: Sendable, Hashable {
  /// Metadata shared by the control.
  public let metadata: AudioControlMetadata
  /// The configured selector values or custom-property pairs.
  public let values: [AudioSelectorValue]
  /// The selector values selected when the device is created.
  public let initialValues: [UInt32]
  /// Creates a value from the supplied AudioDriverKit fields.
  public init(metadata: AudioControlMetadata, values: [AudioSelectorValue], initialValues: [UInt32])
  {
    self.metadata = metadata
    self.values = values
...
public struct AudioSliderControlConfiguration: Sendable, Hashable {
  /// Metadata shared by the control.
  public let metadata: AudioControlMetadata
  /// The value selected when the device is created.
...
public struct AudioStereoPanControlConfiguration: Sendable, Hashable {
  /// Metadata shared by the control.
  public let metadata: AudioControlMetadata
  /// The value selected when the device is created.
...
/// A string-backed AudioDriverKit custom property.
public struct AudioCustomPropertyConfiguration: Sendable, Hashable {
  /// A stable identifier used by Swift runtime commands.
  public let identifier: UInt32
  /// The custom AudioDriverKit property selector.
